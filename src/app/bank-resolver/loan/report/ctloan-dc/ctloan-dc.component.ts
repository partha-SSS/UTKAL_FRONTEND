...
import { SystemValues, p_report_param, mm_customer, mm_operation, mm_block } from 'src/app/bank-resolver/Models';
...
@Component({
  selector: 'app-ctloan-dc',
  templateUrl: './ctloan-dc.component.html',
  styleUrls: ['./ctloan-dc.component.css']
})
export class CTloanDCComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reportcriteria = this.formBuilder.group({
      ...
      block_name: [null, Validators.required],
  ...
  public SubmitReport() {
    this.comser.getDay(this.reportcriteria.controls.fromDate.value,this.reportcriteria.controls.toDate.value)
      ...
      var dt={
        ...
        "block_name":this.reportcriteria.controls.block_name.value,
        "sex":this.reportcriteria.controls.sex.value
        // "acc_cd":this.reportcriteria.controls.acc_type_cd.value,
      }
      this.svc.addUpdDel('Loan/PopulateDcStatementBlockwise',dt).subscribe(data=>{console.log(data)
