...
@Component({
  selector: 'app-gold-loan-master',
  templateUrl: './gold-loan-master.component.html',
  styleUrls: ['./gold-loan-master.component.css']
})
export class GoldLoanMasterComponent {
...
public getSlabMaster() {
  ...
  this.svc.addUpdDel('Loan/GetGoldLoanMasterData',null).subscribe(data=>{
    console.log(data);
    debugger
    this.slabMaster=data
    if(this.slabMaster.length==0){
