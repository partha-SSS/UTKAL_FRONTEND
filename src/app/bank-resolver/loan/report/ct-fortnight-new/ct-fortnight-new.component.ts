...
@Component({
  selector: 'app-ct-fortnight-new',
  templateUrl: './ct-fortnight-new.component.html',
  styleUrls: ['./ct-fortnight-new.component.css']
})
export class CtFortnightNewComponent {
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Loan/FortNightlyReturn',dt).subscribe(data=>{console.log(data)
        this.Alldata=data[0];
          ...
          this.reportData7=this.Alldata.target_Lending_Financial_Year.filter(e=>e.brn_cd==this.sys.BranchCode)
