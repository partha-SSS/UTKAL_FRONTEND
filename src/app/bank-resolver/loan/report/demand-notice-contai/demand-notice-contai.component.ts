...
@Component({
  selector: 'app-demand-notice-contai',
  templateUrl: './demand-notice-contai.component.html',
  styleUrls: ['./demand-notice-contai.component.css'],
  providers:[DatePipe]
})
export class DemandNoticeContaiComponent implements OnInit {
