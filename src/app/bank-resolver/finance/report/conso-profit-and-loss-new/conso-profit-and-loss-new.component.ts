...
@Component({
  ...
  templateUrl: './conso-profit-and-loss-new.component.html',
  styleUrls: ['./conso-profit-and-loss-new.component.css'],
  providers:[ExportAsService]

})
export class ConsoProfitAndLossNewComponent implements OnInit {
