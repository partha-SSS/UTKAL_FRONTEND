...
@Component({
  selector: 'app-gold-loan-closing-rep',
  templateUrl: './gold-loan-closing-rep.component.html',
  styleUrls: ['./gold-loan-closing-rep.component.css'],
  providers:[ExportAsService]
})
export class GoldLoanClosingRepComponent implements OnInit {
...
broFund:any[]=[]
  ...
  displayedColumns: string[] = ['SL_NO','party_cd','loan_id','goldsafe_id','gross_we','net_we','loan_close_dt'];
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      var dt={
        ...
        "loan_close_dt":this.fromdate.toISOString()
      }
      this.svc.addUpdDel('Loan/GoldLoanCloseRep',dt).subscribe(data=>{console.log(data)
        this.reportData=data
        this.reportData2=data
        this.reportData =  this.reportData.sort((a, b) => (a.loan_id < b.loan_id ? -1 : 1));
        ...
        this.reportData.forEach(e => {
          this.gross_we_sum+=e.gross_we
          this.net_we_sum+=e.net_we
        });
        console.log(this.gross_we_sum,this.net_we_sum);
        ...
        // this.reportData.forEach(e => {
        //   this.gross_we_sum+=e.curR_INTT
        //   this.net_we_sum+=e.curR_PRN
        // });
      },err => {
        this.isLoading = false;
