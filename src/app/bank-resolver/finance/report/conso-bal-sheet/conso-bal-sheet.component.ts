...
@Component({
  selector: 'app-conso-bal-sheet',
  templateUrl: './conso-bal-sheet.component.html',
  styleUrls: ['./conso-bal-sheet.component.css'],
  providers:[ExportAsService]
})
export class ConsoBalSheetComponent implements OnInit {
  ...
  downloadexcel(){
    ...
    this.exportAsService.save(this.exportAsConfig, 'ConsoBalanceSheet').subscribe(() => {
      // save started
      console.log("hello")
    });
  }
