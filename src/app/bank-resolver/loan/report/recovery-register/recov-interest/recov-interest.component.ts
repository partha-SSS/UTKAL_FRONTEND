...
@Component({
  selector: 'app-recov-interest',
  templateUrl: './recov-interest.component.html',
  styleUrls: ['./recov-interest.component.css']
})
export class RecovInterestComponent implements OnInit {

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild('content', { static: true }) content: TemplateRef<any>;
  displayedColumns: string[] = ['acc_name','cur_intt','ovd_intt','tot_intt'];
