...
@Component({
  selector: 'app-recov-village',
  templateUrl: './recov-village.component.html',
  styleUrls: ['./recov-village.component.css']
})
export class RecovVillageComponent implements OnInit {

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild('content', { static: true }) content: TemplateRef<any>;
  displayedColumns: string[] = ['acc_cd','Village'];
  ...
  public SubmitReport() {
    ...
    if(this.comser.loanRec){
      ...
      this.svc.addUpdDel('Loan/PopulateRecoveryRegisterVillWise',dt).subscribe(data=>{console.log(data)
