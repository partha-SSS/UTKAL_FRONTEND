...
@Component({
  selector: 'app-near-maturity-report',
  templateUrl: './near-maturity-report.component.html',
  styleUrls: ['./near-maturity-report.component.css'],
  providers:[ExportAsService]

})
export class NearMaturityReportComponent implements OnInit,AfterViewInit {
  @ViewChild('content', { static: true }) content: TemplateRef<any>;
  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  dataSource = new MatTableDataSource()
  displayedColumns: string[] = ['acc_type_desc', 'acc_num', 'cust_name', 'prn_amt','penal_amt','penal_intt_rt','opening_dt','mat_dt','intt_amt','intt_rt'];
  ...
  public SubmitReport() {
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Deposit/PopulateNearMatDetails',dt).subscribe(data=>{console.log(data)
