...
@Component({
  selector: 'app-user-wise-transaction',
  templateUrl: './user-wise-transaction.component.html',
  styleUrls: ['./user-wise-transaction.component.css'],
  providers:[ExportAsService]

})
export class UserWiseTransactionComponent implements OnInit,AfterViewInit {
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Deposit/GetUserwiseTransDepositDtls',dt).subscribe(data=>{
        console.log(data)
