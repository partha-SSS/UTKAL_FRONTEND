...
export class DetailListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['sl_no','block_name','acc_name','party_name', 'acc_num', 'list_dt','curr_intt_rate','plus','curr_prn','ovd_prn','curr_intt','ovd_intt','gross_wt','net_wt','computed_till_dt'];
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Loan/PopulateLoanDetailedList',dt).subscribe(data=>{console.log(data)
        ...
        this.reportData.forEach(e => {
          ...
          this.totGrossWt+=e.gross_wt
          this.totNetWt+=e.net_wt
          ...
          this.dummytotNetWt+=e.net_wt
          this.dummytotGrossWt+=e.gross_wt
        });
      },err => {
        this.isLoading = false;
...
debugger
  ...
  resetList(){
   ...
   this.totPenal=this.dummytotPenal
    this.totGrossWt=this.dummytotGrossWt
    this.totNetWt=this.dummytotGrossWt
