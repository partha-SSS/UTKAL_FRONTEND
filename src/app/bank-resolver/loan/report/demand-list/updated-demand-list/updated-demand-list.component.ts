...
@Component({
  selector: 'app-updated-demand-list',
  templateUrl: './updated-demand-list.component.html',
  styleUrls: ['./updated-demand-list.component.css'],
  providers:[DatePipe]
})
export class UpdatedDemandListComponent {
