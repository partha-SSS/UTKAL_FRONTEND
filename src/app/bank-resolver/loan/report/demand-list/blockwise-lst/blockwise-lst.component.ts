...
@Component({
  selector: 'app-blockwise-lst',
  templateUrl: './blockwise-lst.component.html',
  styleUrls: ['./blockwise-lst.component.css']
})
export class BlockwiseLstComponent implements OnInit {
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Loan/GetDemandBlockwise',dt).subscribe(data=>{console.log(data)
        ...
        this.reportData.forEach(e => {
          ...
          this.totPrn+=e.curr_prn+e.ovd_prn
          this.totIntt+=e.curr_intt+e.ovd_intt+e.penal_intt
