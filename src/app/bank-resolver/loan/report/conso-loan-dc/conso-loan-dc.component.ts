...
@Component({
  selector: 'app-conso-loan-dc',
  templateUrl: './conso-loan-dc.component.html',
  styleUrls: ['./conso-loan-dc.component.css']
})
export class ConsoLoanDCComponent {
  ...
  public SubmitReport() {
    this.comser.getDay(this.reportcriteria.controls.fromDate.value,this.reportcriteria.controls.toDate.value)
      ...
      this.svc.addUpdDel('Loan/PopulateDcStatementConso',dt).subscribe(data=>{console.log(data)
