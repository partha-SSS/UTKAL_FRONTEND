...
@Component({
  selector: 'app-dailybook-new',
  templateUrl: './dailybook-new.component.html',
  styleUrls: ['./dailybook-new.component.css'],
  providers:[ExportAsService]
})
export class DailybookNewComponent implements OnInit ,AfterViewInit{
...
// get the time as a string
  ...
  public SubmitReport() {
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Finance/CashBookReport',dt).subscribe(data=>{console.log(data)
