...
@Component({
  selector: 'app-recov-block',
  templateUrl: './recov-block.component.html',
  styleUrls: ['./recov-block.component.css']
})
export class RecovBlockComponent implements OnInit {
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Loan/PopulateRecoveryRegisterFundwiseBlockwise',dt).subscribe(data=>{console.log(data)
        ...
        if(this.reportData.length==0){
          ...
          this.totovdInttSum+=this.reportData[i].blocktype.tot_block_ovd_intt_recov
          this.totcurrInttSum+=this.reportData[i].blocktype.tot_block_curr_intt_recov
          this.totpenalInttSum+=this.reportData[i].blocktype.tot_block_penal_intt_recov
          this.totcurrPrnSum+=this.reportData[i].blocktype.tot_block_curr_prn_recov
          this.totovdPrnSum+=this.reportData[i].blocktype.tot__block_ovd_prn_recov
          this.totadvPrnSum+=this.reportData[i].blocktype.tot__block_adv_prn_recov
          this.totPrn+=this.reportData[i].blocktype.tot_block_recov
          this.gcount+=this.reportData[i].blocktype.tot_count_block
