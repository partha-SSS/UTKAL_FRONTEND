...
@Component({
  selector: 'app-conso-loan-dc-rh',
  templateUrl: './conso-loan-dc-rh.component.html',
  styleUrls: ['./conso-loan-dc-rh.component.css']
})
export class ConsoLoanDcRHComponent {
  ...
  public SubmitReport() {
    this.comser.getDay(this.reportcriteria.controls.fromDate.value,this.reportcriteria.controls.toDate.value)
      ...
      this.svc.addUpdDel('Loan/PopulateRHDcStatementConso',dt).subscribe(data=>{console.log(data)
