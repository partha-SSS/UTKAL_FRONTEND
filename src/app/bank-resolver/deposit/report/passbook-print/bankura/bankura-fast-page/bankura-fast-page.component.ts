...
@Component({
  selector: 'app-bankura-fast-page',
  templateUrl: './bankura-fast-page.component.html',
  styleUrls: ['./bankura-fast-page.component.css']
})
export class BankuraFastPageComponent {
