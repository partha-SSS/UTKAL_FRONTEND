...
@Component({
  selector: 'app-conso-gen-ledger',
  templateUrl: './conso-gen-ledger.component.html',
  styleUrls: ['./conso-gen-ledger.component.css'],
  providers:[ExportAsService]
})
export class ConsoGenLedgerComponent implements OnInit{
  ...
  public SubmitReport() {
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Finance/GetGeneralLedgerConsole',dt).subscribe(data=>{console.log(data)
