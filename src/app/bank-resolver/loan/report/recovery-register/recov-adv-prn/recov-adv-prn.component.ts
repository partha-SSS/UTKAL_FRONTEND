...
@Component({
  selector: 'app-recov-adv-prn',
  templateUrl: './recov-adv-prn.component.html',
  styleUrls: ['./recov-adv-prn.component.css']
})
export class RecovAdvPrnComponent implements OnInit {
