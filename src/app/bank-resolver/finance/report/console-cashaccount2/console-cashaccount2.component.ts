...
@Component({
  selector: 'app-console-cashaccount2',
  templateUrl: './console-cashaccount2.component.html',
  styleUrls: ['./console-cashaccount2.component.css'],
  providers:[ExportAsService]
  
})
export class ConsoleCashaccount2Component implements OnInit ,AfterViewInit{
...
// get the time as a string
  ...
  public SubmitReport() {
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Finance/CashAccountConsole',dt).subscribe(data=>{console.log(data)
