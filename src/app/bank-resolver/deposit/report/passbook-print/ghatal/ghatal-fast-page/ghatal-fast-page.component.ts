...
@Component({
  selector: 'app-ghatal-fast-page',
  templateUrl: './ghatal-fast-page.component.html',
  styleUrls: ['./ghatal-fast-page.component.css']
})
export class GhatalFastPageComponent implements OnInit {
