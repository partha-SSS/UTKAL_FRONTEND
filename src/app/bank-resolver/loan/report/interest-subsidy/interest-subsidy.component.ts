...
@Component({
  selector: 'app-interest-subsidy',
  templateUrl: './interest-subsidy.component.html',
  styleUrls: ['./interest-subsidy.component.css']
})
export class InterestSubsidyComponent implements OnInit ,AfterViewInit{
