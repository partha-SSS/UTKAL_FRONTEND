...
@Component({
  selector: 'app-block-wise-col-lst',
  templateUrl: './block-wise-col-lst.component.html',
  styleUrls: ['./block-wise-col-lst.component.css']
})
export class BlockWiseColLstComponent implements OnInit {
