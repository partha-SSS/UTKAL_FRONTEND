...
@Component({
  selector: 'app-loan-disb-summary',
  templateUrl: './loan-disb-summary.component.html',
  styleUrls: ['./loan-disb-summary.component.css'],
  providers:[ExportAsService]
})
export class LoanDisbSummaryComponent implements OnInit {
 ...
 onLoadScreen(content) {
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Loan/PopulateBranchWiseLoanDisbSummary',dt).subscribe(data=>{
        console.log(data)
