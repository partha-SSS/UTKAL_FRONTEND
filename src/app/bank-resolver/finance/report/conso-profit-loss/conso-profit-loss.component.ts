...
@Component({
  selector: 'app-conso-profit-loss',
  templateUrl: './conso-profit-loss.component.html',
  styleUrls: ['./conso-profit-loss.component.css'],
  providers:[ExportAsService]
})
export class ConsoProfitLossComponent implements OnInit {
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Finance/PopulateProfitandLossConso',dt).subscribe(data=>{console.log(data)
  ...
  downloadexcel(){
    ...
    this.exportAsService.save(this.exportAsConfig, 'ConsoProfit&Loss').subscribe(() => {
      // save started
      console.log("hello")
    });
  }
