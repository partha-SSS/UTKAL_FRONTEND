...
@Component({
  selector: 'app-recov-normal',
  templateUrl: './recov-normal.component.html',
  styleUrls: ['./recov-normal.component.css']
})
export class RecovNormalComponent implements OnInit {
