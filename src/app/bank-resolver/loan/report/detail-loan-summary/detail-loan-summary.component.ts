...
@Component({
  selector: 'app-detail-loan-summary',
  templateUrl: './detail-loan-summary.component.html',
  styleUrls: ['./detail-loan-summary.component.css'],
  providers:[ExportAsService]
})
export class DetailLoanSummaryComponent implements OnInit {
 ...
 onLoadScreen(content) {
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Loan/PopulateBranchWiseLoanSummary',dt).subscribe(data=>{
        console.log(data)
