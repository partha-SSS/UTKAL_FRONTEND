...
@Component({
  selector: 'app-cashaccount2',
  templateUrl: './cashaccount2.component.html',
  styleUrls: ['./cashaccount2.component.css'],
  providers:[ExportAsService]
  
})
export class Cashaccount2Component implements OnInit ,AfterViewInit{
...
// get the time as a string
  ...
  public SubmitReport() {
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Finance/CashAccount',dt).subscribe(data=>{console.log(data)
