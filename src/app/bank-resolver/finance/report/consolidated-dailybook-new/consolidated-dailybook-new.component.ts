...
@Component({
  selector: 'app-consolidated-dailybook-new',
  templateUrl: './consolidated-dailybook-new.component.html',
  styleUrls: ['./consolidated-dailybook-new.component.css'],
  providers:[ExportAsService]
})
export class ConsolidatedDailybookNewComponent implements OnInit ,AfterViewInit{
  ...
  // displayedColumns: string[] = ['credit_cash','credit_trf','credit_total','acc_cd', 'acc_name', 'debit_cash','debit_trf','debit_total'];
  filteredArray:any=[]
  modalRef: BsModalRef;
  isOpenFromDp = false;
  isOpenToDp = false;
...
// get the time as a string
  ...
  public SubmitReport() {
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Finance/CashBookReportConsole',dt).subscribe(data=>{console.log(data)
      ...
      this.reportData.forEach(e=>{
        this.crCashSum+=e.credit_cash;
        this.crTrfSum+=e.credit_trf;
        this.crTotalSum+=e.credit_total;
        this.drCashSum+=e.debit_cash;
        this.drTrfSum+=e.debit_trf;
        this.drTotalSum+=e.debit_total;
      })
      }
