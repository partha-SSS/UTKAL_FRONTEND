...
debugger
  ...
  validateData() {
    ...
    if ((this.td_deftrans.amount != this.td_deftranstrfList[0].amount) && (this.td_deftrans.trf_type=='T')) {
    ...
    for (const l in this.td_nomineeList) {
      if (this.td_nomineeList[l].nom_name === null || this.td_nomineeList[l].nom_name === undefined) {
        ...
        this.td_nomineeList[l].acc_num = this.masterModel.tmlocker.agreement_no;
