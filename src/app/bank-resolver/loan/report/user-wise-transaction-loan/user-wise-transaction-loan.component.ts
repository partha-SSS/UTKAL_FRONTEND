...
@Component({
  selector: 'app-user-wise-transaction-loan',
  templateUrl: './user-wise-transaction-loan.component.html',
  styleUrls: ['./user-wise-transaction-loan.component.css']
})
export class UserWiseTransactionLoanComponent implements OnInit {
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Loan/GetUserwiseTransDtls',dt).subscribe(data=>{
        console.log(data)
