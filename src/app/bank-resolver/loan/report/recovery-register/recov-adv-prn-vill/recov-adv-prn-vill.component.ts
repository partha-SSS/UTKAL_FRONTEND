...
@Component({
  selector: 'app-recov-adv-prn-vill',
  templateUrl: './recov-adv-prn-vill.component.html',
  styleUrls: ['./recov-adv-prn-vill.component.css']
})
export class RecovAdvPrnVillComponent implements OnInit {
